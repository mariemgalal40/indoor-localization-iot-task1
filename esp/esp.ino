////for collecting the data in excel sheets 
//#include <stdio.h>
//#include <string.h>
//#include <stdlib.h>
//#include <ESP8266WiFi.h>
//
//String saved_networks[] = {"","STUDBME2","STUDBME1", "Mariem", "Aya","Alaa1","Alaa","Hassan","amany","CMP-lab1"};
...
////for sending the readings to firebase
...
#define FIREBASE_HOST "localization-26a20-default-rtdb.firebaseio.com"      
#define FIREBASE_AUTH "O2pO08sEppZqZEjlcLJnvlFRfUEtqvDHrTgRXfjx"
#define WIFI_SSID "AndroidAP"
#define WIFI_PASSWORD "utjw5537"
...
{   
    ...
    else
    {
        printToSerial();
        convertIntToString();
          Firebase.setString("/RSSI", rssi_characters);            
    if (Firebase.failed()) 
    {
